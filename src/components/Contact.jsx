...
export const Contact = () => {
    return (
        <div className='fixed -right-36 hover:right-0 transition-all cursor-pointer duration-500 bottom-24 z-[1500] bg-transparent hover:bg-htpSystem rounded-l-full'>
