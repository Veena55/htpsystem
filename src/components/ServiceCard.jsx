...
export const ServiceCard = ({ logo, title, gap, content, list }) => {
    ...
    return (
        <div className={`bg-themeLight p-10 rounded-lg flex flex-col h-full justify-start items-center gap-5 ${gap}`}>
            <div className='bg-white border p-2 text-theme2 rounded-md'>
                {logo}
            </div>
            <div>
                <h1 className='text-theme2 text-center text-md lg:text-2xl font-medium'>{title}</h1>
