...
export const Services = () => {
    ...
    return (
        <div className='bg-theme1 text-center p-5 lg:p-8 xl:p-10' id='services'>
            <div className='text-2xl lg:text-4xl font-medium inline-block'><span className='text-white pr-2 border-b-4 border-b-red-500'>Our</span><span className='border-b-4 border-b-white text-htpSystem'>Services</span></div>
            <div className="relative min-h-screen my-5" ref={service}>
                <div className='flex flex-col lg:flex-row lg:justify-center pt-10 lg:pt-16'>
                ...
                <div className="md:px-5 lg:px-0 py-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 xl:gap-10">
